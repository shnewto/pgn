...
sampleChessDotComPgnTagPairParsed =
    [ { title = "Link", value = "https://www.chess.com/daily/game/256312384" }, { title = "EndTime", value = "03:59:06" }, { title = "EndDate", value = "2020.04.01" }, { title = "StartTime", value = "23:53:48" }, { title = "Termination", value = "shnewto won by resignation" }, { title = "TimeControl", value = "1/86400" }, { title = "BlackElo", value = "1135" }, { title = "WhiteElo", value = "1063" }, { title = "UTCTime", value = "23:53:48" }, { title = "UTCDate", value = "2020.03.27" }, { title = "Timezone", value = "UTC" }, { title = "CurrentPosition", value = "1q6/6p1/K1P2pk1/8/P3p3/8/8/8 w - - 0 57" }, { title = "ECOUrl", value = "https://www.chess.com/openings/Barnes-Opening-1...d5-2.e4" }, { title = "ECO", value = "A00" }, { title = "Result", value = "0-1" }, { title = "Black", value = "shnewto" }, { title = "White", value = "flukeout" }, { title = "Round", value = "-" }, { title = "Date", value = "2020.03.27" }, { title = "Site", value = "Chess.com" }, { title = "Event", value = "Let's Play!" } ]
